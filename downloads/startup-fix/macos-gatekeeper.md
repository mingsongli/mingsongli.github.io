...
> “Acycle3_1_1” is damaged and can’t be opened. You should move it to the Trash.
...
```shell
xattr -dr com.apple.quarantine "/Applications/Acycle3_1_1.app"
```
...
Leave a space at the end, drag `Acycle3_1_1.app` from Finder into the Terminal window, and press Return.
...
```shell
sudo xattr -dr com.apple.quarantine "/Applications/Acycle3_1_1.app"
```
...
### Acycle 3.1.1 - macOS Apple M Chip 启动修复
...
> “Acycle3_1_1”已损坏，无法打开。你应该将它移到废纸篓。
...
注意末尾保留一个空格，然后把 `Acycle3_1_1.app` 从 Finder 拖入终端窗口，再按回车。
